...
def uniform_cost_search(start_state):
    ...
    while queue:
        ...
        # Move to neighboring locations if battery allows
        ...
        #  Pick up orders at R1 if capacity allows
        if location == 'R1':
            for order in ORDERS:
        ...
        #  Deliver orders at their destinations
